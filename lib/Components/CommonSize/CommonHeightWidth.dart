...
import 'package:national_bonds_app/utils/CustomLogger.dart';
...
// A factory method that creates or returns the singleton instance
  ...
  void _logDimensions() {
    devLog("SCREEN WIDTH: $width");
    devLog("SCREEN HEIGHT: $height");
    devLog("ORIENTATION: $orientation");
    devLog("GRID: $gridItemCount");
  }
}
